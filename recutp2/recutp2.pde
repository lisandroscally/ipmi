//Lisandro Scally, tp2 recuperatorio, comision 3, legajo: 125687/8
...
void drawMiembros() {
  ...
  textSize (11);
  text ("Roger Cardero - Baterista", width/2.2,260);
  image (Roger,240,150);
  Roger.resize (100,100);
}
